pipeline {
  ...
  stages {
      ...
      stage('SonarQube - SAST') {
        steps {
          sh 'mvn sonar:sonar -Dsonar.projectKey=numeric-application -Dsonar.projectName='numeric-application' -Dsonar.host.url=http://devsecops.example.local:9000 -Dsonar.token=sqp_7b20965f43df7559ab19947f6e15fa8e20a464cd'
        }
      } 
