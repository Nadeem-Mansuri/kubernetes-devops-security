pipeline {
  ...
  stages {
      ...
      stage('SonarQube - SAST') {
        steps {
          sh 'mvn clean verify sonar:sonar -Dsonar.projectKey=numeric-application -Dsonar.projectName=numeric-application -Dsonar.host.url=http://192.168.1.38:9000 -Dsonar.token=sqp_c1ac73c778f852442adccafad5938f8e4a6f6688'
        }
      }
